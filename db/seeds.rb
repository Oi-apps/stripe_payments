...
# growth_hacking = Product.create(title: "Growth Hacking", subtitle: "Crash Course", author: "Mattan Griffel", length: "30 minutes",
# author_image_name: "teacher-image.jpg", price: "4.99", sku: "GROHACK1", download_url: "https://s3.amazonaws.com/spider-oak/Hive+Startup+Guide+-+Linux.pdf", details: "You'll get one video",
...
growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly", subtitle: "Ongoing Course", author: "Mattan Griffel", length: "6 months",
author_image_name: "teacher-image.jpg", price: "4.99", sku: "GROHACK2", download_url: "https://s3.amazonaws.com/spider-oak/Hive+Startup+Guide+-+Linux.pdf", details: "We'll charge you monthly for unlimited access to our mentoring team",
 description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
...
copywriting_monthly = Product.create(title: "Copywriting Monthly", subtitle: "Ongoing Course", author: "Mattan Griffel", length: "6 months",
author_image_name: "teacher-image.jpg", price: "4.99", sku: "COPYWRITE2", download_url: "https://s3.amazonaws.com/spider-oak/Hive+Startup+Guide+-+Linux.pdf", details: "We'll charge you monthly for unlimited access to our mentoring team",
 description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
            ...
            <ul class="no-indent">
                ...
                <li>Seven secrets of dicecxt copy ad sales</li>
                <li>How to apply the Lean Marketing Framework</li>
                <li>Resources and tools you'll need to know</li>
            </ul>},
            author_description: %{<p>Hey, I'm Mattan Griffel, co-founder of the Y Combinator backed <a href="http://www.onemonth.com" target="_blank">One Month</a> where I teach the best selling One Month Rails and One Month Growth Hacking.</p>
...
analytics_monthly = Product.create(title: "Analytics Monthly", subtitle: "Ongoing Course", author: "Mattan Griffel", length: "6 months",
author_image_name: "teacher-image.jpg", price: "4.99", sku: "ANALYTICS2", download_url: "https://s3.amazonaws.com/spider-oak/Hive+Startup+Guide+-+Linux.pdf", details: "We'll charge you monthly for unlimited access to our mentoring team",
 description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>

            <p>In this series, Mattan Griffel introduces you to the concept of Copywriting and shares his favorite tips for getting started as a growth hacker.</p>
            <p><strong>What You'll Learn</strong></p>
            <ul class="no-indent">
                <li>How to use mix panal effectively</li>
                <li>Seven secrets of dicecxt copy ad sales</li>
